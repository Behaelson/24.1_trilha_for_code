...
# Considerando "CPython" um termo substituível 
# (tendo em vista que há "Python" na palavra, mas a palavra em si não é "Python" apenas)
print(var1.replace("Python", "Fython"), '\n')

# Não considerando "CPython" um termo que deveria ser substituido
print(var1.replace("Python", "Fython", 2))